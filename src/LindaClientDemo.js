...
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
var $2,$6,$5,$4,$3,$7,$11,$10,$9,$8,$12,$16,$15,$14,$13,$17,$18,$19,$21,$20,$22,$28,$27,$26,$25,$31,$30,$29,$24,$23,$32,$36,$35,$34,$33,$37,$44,$43,$42,$41,$40,$39,$38,$1;
$1=(function(event){
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
return $core.withContext(function($ctx2) {
//>>excludeEnd("ctx");
...
$ctx2.sendIdx["at:"]=4;
//>>excludeEnd("ctx");
$recv($17)._value_($recv(event)._gamma());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["value:"]=4;
//>>excludeEnd("ctx");
$18=$recv(self["@viewModel"])._at_("tiltFB");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=5;
//>>excludeEnd("ctx");
$recv($18)._value_($recv(event)._beta());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["value:"]=5;
//>>excludeEnd("ctx");
$19=$recv(self["@viewModel"])._at_("gZ");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=6;
//>>excludeEnd("ctx");
$21=$recv($recv($recv(event)._accelerationIncludingGravity())._z()).__star((10));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["*"]=4;
//>>excludeEnd("ctx");
$20=$recv($21)._rounded();
...
//>>excludeEnd("ctx");
$22=$recv(self["@viewModel"])._at_("webRotate");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=7;
//>>excludeEnd("ctx");
$28=$recv(self["@viewModel"])._at_("tiltLR");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=8;
//>>excludeEnd("ctx");
...
//>>excludeEnd("ctx");
$26="rotate(".__comma($27);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=4;
//>>excludeEnd("ctx");
$25=$recv($26).__comma("deg) rotate3d(1,0,0, ");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=3;
//>>excludeEnd("ctx");
$31=$recv(self["@viewModel"])._at_("tiltFB");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=9;
//>>excludeEnd("ctx");
$30=$recv($31).__star((-1));
...
//>>excludeEnd("ctx");
$32=$recv(self["@viewModel"])._at_("mozRotate");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=10;
//>>excludeEnd("ctx");
$36=$recv(self["@viewModel"])._at_("tiltLR");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=11;
//>>excludeEnd("ctx");
$35=$recv($36)._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["printString"]=3;
//>>excludeEnd("ctx");
$34="rotate(".__comma($35);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=6;
//>>excludeEnd("ctx");
$33=$recv($34).__comma("deg)");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=5;
//>>excludeEnd("ctx");
$recv($32)._value_($33);
...
//>>excludeEnd("ctx");
$37=$recv(self["@viewModel"])._at_("rotateYX");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=12;
//>>excludeEnd("ctx");
$44=$recv(self["@viewModel"])._at_("gY");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=13;
//>>excludeEnd("ctx");
$43=$recv($44)._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["printString"]=4;
//>>excludeEnd("ctx");
$42="rotateX(".__comma($43);
$41=$recv($42).__comma("deg)");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=10;
//>>excludeEnd("ctx");
$40=$recv($41).__comma(" rotateY(");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=9;
//>>excludeEnd("ctx");
$39=$recv($40).__comma($recv($recv(self["@viewModel"])._at_("gX"))._printString());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=8;
//>>excludeEnd("ctx");
$38=$recv($39).__comma("deg)");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=7;
//>>excludeEnd("ctx");
return $recv($37)._value_($38);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
}, function($ctx2) {$ctx2.fillBlock({event:event},$ctx1,1)});
//>>excludeEnd("ctx");
});
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "devicemotionHandler\x0a\x09^[:event |\x0a\x09\x09\x22(viewModel at: #accX) value: event acceleration x.\x0a\x09\x09(viewModel at: #accY) value: event acceleration y.\x0a\x09\x09(viewModel at: #accZ) value: event acceleration z.\x22\x0a\x09\x09(viewModel at: #gX) value: (event accelerationIncludingGravity x * 10) rounded.\x0a\x09\x09(viewModel at: #gY) value: (event accelerationIncludingGravity y * 10) rounded.\x0a\x09\x09(viewModel at: #gZ) value: (event accelerationIncludingGravity z * 10) rounded.\x0a\x09\x09(viewModel at: #tiltLR) value: event gamma.\x0a\x09\x09(viewModel at: #tiltFB) value: event beta.\x0a\x09\x09(viewModel at: #gZ) value: (event accelerationIncludingGravity z * 10) rounded.\x0a\x09\x09(viewModel at: #webRotate) value: 'rotate(', (viewModel at: #tiltLR) printString, 'deg) rotate3d(1,0,0, ', ((viewModel at: #tiltFB) * -1) printString, 'deg)' .\x0a\x09\x09(viewModel at: #mozRotate) value: 'rotate(', (viewModel at: #tiltLR) printString, 'deg)' .\x0a\x09\x09(viewModel at: #rotateYX) value: 'rotateX(', ((viewModel at: #gY)) printString, 'deg)', \x0a\x09\x09' rotateY(', ((viewModel at: #gX)) printString, 'deg)'\x0a\x09].",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: ["value:", "at:", "rounded", "*", "x", "accelerationIncludingGravity", "y", "z", "gamma", "beta", ",", "printString"]
}),
$globals.LindaGyroWorker);
