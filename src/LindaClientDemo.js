...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "philosopherTupleSpace\x0a\x09| lindaClient |\x0a\x09lindaClient := LindaClient default.\x0a\x09^lindaClient tupleSpace: 'philTable'\x0a\x09\x0a\x09",
referencedClasses: ["LindaClient"],
//>>excludeEnd("ide");
messageSends: ["default", "tupleSpace:"]
}),
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "resetStartButton\x0a\x09\x0a\x09'#start' asJQuery text: 'START'",
referencedClasses: [],
//>>excludeEnd("ide");
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "clearResults\x0a\x0a\x09|  resultTuple |\x0a\x09resultTuple := FibTuple result.\x0a\x09(self n to: 1 by: -1) do: [:i |\x0a\x09\x09resultTuple n: i.\x0a\x09\x09self tupleSpace takep: resultTuple wait: 10 callback: [:e :t | ]].\x0a\x09\x09\x0a\x09resultTuple n: 0; answer: 0.\x0a\x09self tupleSpace takep: resultTuple wait: 10 callback: [:e :t | ].",
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "startMap\x0a\x09| requestTuple resultTuple |\x0a\x09resultTuple := FibTuple result.\x0a\x09\x0a\x09(self n to: 1 by: -1) do: [:i |\x0a\x09\x09requestTuple := FibTuple fib.\x0a\x09\x09requestTuple n: i.\x0a\x09\x09self tupleSpace write: requestTuple.\x0a\x09\x09self decNumberOfEntry].\x0a\x09\x09\x0a\x09resultTuple n: 0; answer: 0.\x0a\x09self tupleSpace write: resultTuple.",
referencedClasses: ["FibTuple"],
//>>excludeEnd("ide");
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "example\x0a\x0a\x09| app  lot ts ans|\x0a\x09app := LindaFibMaster new.\x0a\x09app lindaClient: (LindaClient default).\x0a\x09app n: 10.\x0a\x09app startMap.\x0a\x09app readResultTuple.\x0a\x09app inspect\x0a\x09",
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "devicemotionHandler\x0a\x09^[:event |\x0a\x09\x09self \x0a\x0a\x09\x09\x09gX: (event acceleration x * 100) rounded\x0a\x09\x09\x09gY: (event acceleration y * 100) rounded\x0a\x09\x09\x09gZ: (event acceleration z * 100) rounded\x09\x09\x0a\x22\x0a\x09\x09\x09gX: (event accelerationIncludingGravity x * 10) rounded\x0a\x09\x09\x09gY: (event accelerationIncludingGravity y * 10) rounded\x0a\x09\x09\x09gZ: (event accelerationIncludingGravity z * 10) rounded\x09\x09\x0a\x22\x0a\x09].",
referencedClasses: [],
//>>excludeEnd("ide");
