...
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
var $1,$2,$3,$4,$5,$6,$8,$13,$12,$11,$14,$10,$9,$7,$16,$19,$18,$17,$15,$21,$27,$26,$25,$24,$23,$22,$20;
$1="#amber-with"._asJQuery();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx1.sendIdx["asJQuery"]=1;
//>>excludeEnd("ctx");
...
//>>excludeEnd("ctx");
$12="rotate(".__comma($13);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx1.sendIdx[","]=4;
//>>excludeEnd("ctx");
$11=$recv($12).__comma("deg) rotate3d(1,0,0, ");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx1.sendIdx[","]=3;
//>>excludeEnd("ctx");
$14=$recv((30).__star((-1)))._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx1.sendIdx["printString"]=2;
//>>excludeEnd("ctx");
$10=$recv($11).__comma($14);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx1.sendIdx[","]=2;
//>>excludeEnd("ctx");
...
$ctx1.sendIdx[","]=9;
//>>excludeEnd("ctx");
$23=$recv($24).__comma((30)._printString());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx1.sendIdx[","]=8;
//>>excludeEnd("ctx");
...
$ctx1.sendIdx[","]=7;
//>>excludeEnd("ctx");
$20=$recv($21)._observable_($22);
self["@viewModel"]=$globals.HashedCollection._newFromPairs_(["gX",$2,"gY",$3,"gZ",$4,"tiltLR",$5,"tiltFB",$6,"webRotate",$7,"mozRotate",$15,"rotateYX",$20]);
$recv(ko)._applyBindings_(self["@viewModel"]);
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "augmentPage\x0a\x09'#amber-with' asJQuery click: [ self doAmberWith ].\x0a\x09'#silk-tag' asSilk on: #click bind: [ self doSilkTAG ].\x0a\x09'#jquery-append' asJQuery click: [ self doJQueryAppend ].\x0a\x09\x0a\x09viewModel := #{\x0a\x09\x09#gX -> (ko observable: 0) .\x0a\x09\x09#gY -> (ko observable: 0) .\x0a\x09\x09#gZ -> (ko observable: 0) .\x0a\x09\x09#tiltLR -> (ko observable: 0).\x0a\x09\x09#tiltFB -> (ko observable: 0).\x0a\x09\x09#webRotate -> (ko observable: 'rotate(', (30) printString, 'deg) rotate3d(1,0,0, ', ((30) * -1) printString, 'deg)').\x0a\x09\x09#mozRotate -> (ko observable: 'rotate(', (30) printString, 'deg)').\x0a\x09\x09#rotateYX -> (ko observable: \x0a\x09\x09'rotateX(', 30 printString, 'deg)', \x0a\x09\x09' rotateY(', 30 printString, 'deg)')\x0a\x09\x09\x22#rotateYX -> (ko observable: 'rotateX(30deg) rotate(30deg)')\x22\x0a\x09}.\x0a\x09ko applyBindings: viewModel.\x0a\x09window addEventListener: #devicemotion with: self devicemotionHandler.",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: ["click:", "asJQuery", "doAmberWith", "on:bind:", "asSilk", "doSilkTAG", "doJQueryAppend", "observable:", ",", "printString", "*", "applyBindings:", "addEventListener:with:", "devicemotionHandler"]
}),
...
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
var $2,$6,$5,$4,$3,$7,$11,$10,$9,$8,$12,$16,$15,$14,$13,$17,$19,$18,$20,$21,$23,$22,$24,$30,$29,$28,$27,$33,$32,$31,$26,$25,$34,$38,$37,$36,$35,$39,$46,$45,$44,$43,$42,$41,$40,$1;
$1=(function(event){
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
return $core.withContext(function($ctx2) {
//>>excludeEnd("ctx");
...
$ctx2.sendIdx["at:"]=3;
//>>excludeEnd("ctx");
$16=$recv(event)._accelerationIncludingGravity();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["accelerationIncludingGravity"]=3;
//>>excludeEnd("ctx");
$15=$recv($16)._z();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["z"]=1;
//>>excludeEnd("ctx");
$14=$recv($15).__star((10));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["*"]=3;
//>>excludeEnd("ctx");
$13=$recv($14)._rounded();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["rounded"]=3;
//>>excludeEnd("ctx");
$recv($12)._value_($13);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["value:"]=3;
//>>excludeEnd("ctx");
$17=$recv(self["@viewModel"])._at_("tiltLR");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=4;
//>>excludeEnd("ctx");
$19=$recv(event)._rotationRate();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["rotationRate"]=1;
//>>excludeEnd("ctx");
$18=$recv($19)._gamma();
$recv($17)._value_($18);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeEnd("ctx");
$20=$recv(self["@viewModel"])._at_("tiltFB");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=5;
//>>excludeEnd("ctx");
$recv($20)._value_($recv($recv(event)._rotationRate())._beta());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["value:"]=5;
//>>excludeEnd("ctx");
$21=$recv(self["@viewModel"])._at_("gZ");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=6;
//>>excludeEnd("ctx");
$23=$recv($recv($recv(event)._accelerationIncludingGravity())._z()).__star((10));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["*"]=4;
//>>excludeEnd("ctx");
$22=$recv($23)._rounded();
...
//>>excludeEnd("ctx");
$24=$recv(self["@viewModel"])._at_("webRotate");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=7;
//>>excludeEnd("ctx");
$30=$recv(self["@viewModel"])._at_("tiltLR");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=8;
//>>excludeEnd("ctx");
$29=$recv($30)._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["printString"]=1;
//>>excludeEnd("ctx");
$28="rotate(".__comma($29);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=4;
//>>excludeEnd("ctx");
$27=$recv($28).__comma("deg) rotate3d(1,0,0, ");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=3;
//>>excludeEnd("ctx");
$33=$recv(self["@viewModel"])._at_("tiltFB");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=9;
//>>excludeEnd("ctx");
$32=$recv($33).__star((-1));
$31=$recv($32)._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["printString"]=2;
//>>excludeEnd("ctx");
$26=$recv($27).__comma($31);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=2;
//>>excludeEnd("ctx");
$25=$recv($26).__comma("deg)");
...
//>>excludeEnd("ctx");
$34=$recv(self["@viewModel"])._at_("mozRotate");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=10;
//>>excludeEnd("ctx");
$38=$recv(self["@viewModel"])._at_("tiltLR");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=11;
//>>excludeEnd("ctx");
$37=$recv($38)._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["printString"]=3;
//>>excludeEnd("ctx");
$36="rotate(".__comma($37);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=6;
//>>excludeEnd("ctx");
$35=$recv($36).__comma("deg)");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=5;
//>>excludeEnd("ctx");
$recv($34)._value_($35);
...
//>>excludeEnd("ctx");
$39=$recv(self["@viewModel"])._at_("rotateYX");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=12;
//>>excludeEnd("ctx");
$46=$recv(self["@viewModel"])._at_("gY");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=13;
//>>excludeEnd("ctx");
$45=$recv($46)._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["printString"]=4;
//>>excludeEnd("ctx");
$44="rotateX(".__comma($45);
$43=$recv($44).__comma("deg)");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=10;
//>>excludeEnd("ctx");
$42=$recv($43).__comma(" rotateY(");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=9;
//>>excludeEnd("ctx");
$41=$recv($42).__comma($recv($recv(self["@viewModel"])._at_("gX"))._printString());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=8;
//>>excludeEnd("ctx");
$40=$recv($41).__comma("deg)");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=7;
//>>excludeEnd("ctx");
return $recv($39)._value_($40);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
}, function($ctx2) {$ctx2.fillBlock({event:event},$ctx1,1)});
//>>excludeEnd("ctx");
});
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "devicemotionHandler\x0a\x09^[:event |\x0a\x09\x09\x22(viewModel at: #accX) value: event acceleration x.\x0a\x09\x09(viewModel at: #accY) value: event acceleration y.\x0a\x09\x09(viewModel at: #accZ) value: event acceleration z.\x22\x0a\x09\x09(viewModel at: #gX) value: (event accelerationIncludingGravity x * 10) rounded.\x0a\x09\x09(viewModel at: #gY) value: (event accelerationIncludingGravity y * 10) rounded.\x0a\x09\x09(viewModel at: #gZ) value: (event accelerationIncludingGravity z * 10) rounded.\x0a\x09\x09(viewModel at: #tiltLR) value: event rotationRate gamma.\x0a\x09\x09(viewModel at: #tiltFB) value: event rotationRate beta.\x0a\x09\x09(viewModel at: #gZ) value: (event accelerationIncludingGravity z * 10) rounded.\x0a\x09\x09(viewModel at: #webRotate) value: 'rotate(', (viewModel at: #tiltLR) printString, 'deg) rotate3d(1,0,0, ', ((viewModel at: #tiltFB) * -1) printString, 'deg)' .\x0a\x09\x09(viewModel at: #mozRotate) value: 'rotate(', (viewModel at: #tiltLR) printString, 'deg)' .\x0a\x09\x09(viewModel at: #rotateYX) value: 'rotateX(', ((viewModel at: #gY)) printString, 'deg)', \x0a\x09\x09' rotateY(', ((viewModel at: #gX)) printString, 'deg)'\x0a\x09].",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: ["value:", "at:", "rounded", "*", "x", "accelerationIncludingGravity", "y", "z", "gamma", "rotationRate", "beta", ",", "printString"]
}),
$globals.LindaGyroWorker);
