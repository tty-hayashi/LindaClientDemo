...
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
var $2,$6,$5,$4,$3,$7,$11,$10,$9,$8,$12,$13,$20,$19,$18,$17,$16,$15,$14,$1;
$1=(function(event){
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
return $core.withContext(function($ctx2) {
//>>excludeEnd("ctx");
...
$ctx2.sendIdx["at:"]=3;
//>>excludeEnd("ctx");
$recv($12)._value_($recv($recv($recv($recv(event)._accelerationIncludingGravity())._z()).__star((10)))._rounded());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
$ctx2.sendIdx["at:"]=4;
//>>excludeEnd("ctx");
$20=$recv(self["@viewModel"])._at_("gY");
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx["at:"]=5;
//>>excludeEnd("ctx");
$19=$recv($20)._printString();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
$ctx2.sendIdx[","]=3;
//>>excludeEnd("ctx");
$15=$recv($16).__comma($recv($recv(self["@viewModel"])._at_("gX"))._printString());
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx2.sendIdx[","]=2;
//>>excludeEnd("ctx");
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "devicemotionHandler\x0a\x09^[:event |\x0a\x09\x09\x22(viewModel at: #accX) value: event acceleration x.\x0a\x09\x09(viewModel at: #accY) value: event acceleration y.\x0a\x09\x09(viewModel at: #accZ) value: event acceleration z.\x22\x0a\x09\x09(viewModel at: #gX) value: (event accelerationIncludingGravity x * 10) rounded.\x0a\x09\x09(viewModel at: #gY) value: (event accelerationIncludingGravity y * 10) rounded.\x0a\x09\x09(viewModel at: #gZ) value: (event accelerationIncludingGravity z * 10) rounded.\x0a\x09\x09(viewModel at: #rotateYX) value: 'rotateX(', ((viewModel at: #gY)) printString, 'deg)', \x0a\x09\x09' rotateY(', ((viewModel at: #gX)) printString, 'deg)'.\x0a\x09].",
referencedClasses: [],
//>>excludeEnd("ide");
messageSends: ["value:", "at:", "rounded", "*", "x", "accelerationIncludingGravity", "y", "z", ",", "printString"]
}),
$globals.LindaGyroWorker);
