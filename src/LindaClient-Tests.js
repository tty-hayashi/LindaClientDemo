define("amber-lindaclient/LindaClient-Tests", ["amber/boot", "amber_core/SUnit", "amber_core/Kernel-Objects"], function($boot){"use strict";
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
$core.addPackage('LindaClient-Tests');
$core.packages["LindaClient-Tests"].innerEval = function (expr) { return eval(expr); };
$core.packages["LindaClient-Tests"].transport = {"type":"amd","amdNamespace":"amber-lindaclient"};
